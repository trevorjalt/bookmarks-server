...
describe('Bookmarks Endpoints', function () {
    ...
    describe(`Unauthorized requests`, () => {
      ...
      it(`responds with 401 Unauthorized GET /api/bookmarks`, () => {
        return supertest(app)
          .get('/api/bookmarks')
          .expect(401, { error: 'Unauthorized request' })
      })

      it(`responds with 401 Unauthorized POST /api/bookmarks`, () => {
        return supertest(app)
          .post('/api/bookmarks')
      ...
      it(`responds with 401 Unauthorized GET /api/bookmarks/:id`, () => {
      ...
      it(`responds with 401 Unauthorized DELETE /api/bookmarks/:id`, () => {
